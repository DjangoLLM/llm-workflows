...
from agents.runner.tools import ToolRegistry
from agents.adapters.tools.mcp.server import build_mcp_server
...
def test_server_module_does_not_import_fastmcp_at_top():
    """The agents.adapters.tools.mcp.server module must be importable without fastmcp."""
    import subprocess

    code = (
        "import sys\n"
        "import agents.adapters.tools.mcp.server\n"
