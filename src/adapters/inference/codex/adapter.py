...
class CodexRunner(AgentAdapter[CodexRunResult]):
    ...
    @classmethod
    def from_definition(cls, definition: Any) -> CodexRunner:
        ...
        schema = build_codex_output_schema(definition.result_type)
        return cls(
