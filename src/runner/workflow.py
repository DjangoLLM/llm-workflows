...
def execute_workflow_step(
    *,
    ...
    resolved_agent_definition = (
        agent_definition if agent_definition is not None else step.agent_definition
    )
    with transaction.atomic():
        ...
        managed_agent = None
        agent_run = None
        if resolved_agent_definition is not None:
            managed_agent = ManagedAgent(
                definition=resolved_agent_definition, agent_label=step_key
            )
